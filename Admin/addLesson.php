...
if(isset($_REQUEST['lessonSubmitBtn'])){
   ...
   if(($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_description'] == "") || ($_REQUEST['course_name'] == "")) {
      ...
      $query = "INSERT INTO lessons (lesson_name, lesson_description, lesson_link, course_id, course_name)
      VALUES ('$lesson_name', '$lesson_description', '$link_folder','$course_id','$course_name')";
